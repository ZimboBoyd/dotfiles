...
alias homeshick_dotfiles_push="homeshick check dotfiles ; homeshick cd dotfiles ; git commit -am 'Changes on $(date)' ; git push ; homeshick check dotfiles ; git status"
alias homeshick_private_commit="homeshick cd private ; git commit -am 'Changes on $(date)' ; git status"
